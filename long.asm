...
SwitchToLongMode:
    ...
    or eax, PAGE_PRESENT | PAGE_WRITE ; Or EAX with the flags - present flag, writable flag.
    mov [es:di + 0x1ff*8], eax                  ; Store the value of EAX as the first PML4E.
    ...
    or eax, PAGE_PRESENT | PAGE_WRITE ; Or EAX with the flags - present flag, writable flag.
    mov [es:di + 0x4000 + 0x1fe*8], eax         ; Store the value of EAX as the first PDPTE.
    ...
    add eax, 0x200000
    mov [es:di + 0x5008], eax         ; Store to value of EAX as the first PDE.
    add eax, 0x200000
    mov [es:di + 0x5010], eax         ; Store to value of EAX as the first PDE.
